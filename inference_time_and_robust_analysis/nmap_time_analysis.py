...
def main():
    ...
    if banner_lengths and process_times:
        ...
        bins = range(0, max_time + 1, 1)  # 1ms 一个刻度
        ...
        plt.xticks(range(0, max_time + 1, 5))  # 每 5ms 显示一个刻度标签
        ...
        # 生成箱图（无离群点）
        plt.figure(figsize=(10, 6))
        plt.boxplot(filtered_times, showfliers=False)  # 不显示离群点
